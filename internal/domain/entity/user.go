...
type User struct {
	...
	// Informasi identitas (untuk seller verification)
	...
	VerificationStatus string     `json:"verification_status" firestore:"verificationStatus"` // "pending", "verified", "rejected"
	
	// Agregasi rating dari review
